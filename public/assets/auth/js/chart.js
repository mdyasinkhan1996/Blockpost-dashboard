...
if (splinaArea1 !== null) {
  ...
  var data = $('#spline-area-1').data('monthcollp');
  data.forEach( (element, index) => {
    splinaAreaOptions1.series[0].data[index] = element.count
  });
...
if (splinaArea2 !== null) {
  ...
  var data = $('#spline-area-2').data('categorychart');
  data.forEach( (element, index) => {
    splinaAreaOptions2.series[0].data[index] = element.count
  });
...
if (splinaArea3 !== null) {
  ...
  var data = $('#spline-area-3').data('tagschart');
  data.forEach( (element, index) => {
    splinaAreaOptions3.series[0].data[index] = element.count
  });
...
if (splinaArea4 !== null) {
  ...
  var data = $('#spline-area-4').data('userschart');
  data.forEach( (element, index) => {
    splinaAreaOptions4.series[0].data[index] = element.count
  });
